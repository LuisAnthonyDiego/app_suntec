...
class FirebaseDataSource {
  ...
  Stream<Iterable<ModelUser>> getMyUsers() {
    return firestore
        ...
        .snapshots()
        .map((it) => it.docs.map((e) => ModelUser.fromFirebaseMap(e.data())));
  }
  ...
  Future<void> saveMyUser(ModelUser myUser, File? image) async {
  ...
  Future<void> deleteMyUser(ModelUser myUser) async {
    final ref = firestore.doc('user/${currentUser.uid}/myUsers/${myUser.id}');
